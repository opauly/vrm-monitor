...
// cron (Step 9, live: `.github/workflows/scheduled-reports.yml`, hourly),
// same reasoning §3.7 gives for why this button exists at all: "the
// detection surface for 'the cron silently stopped.'" `requireAdminForRoute()`
// is the only gate — there is no customer session on this side, same as
// every other `app/api/admin/pipeline/*` route.
